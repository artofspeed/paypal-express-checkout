 ...
 */
function Paypal(apiUsername, apiPassword, signature, debug, inContext) {
	...
	if (inContext){
		this.redirect = 'https://' + (debug ? 'www.sandbox.paypal.com/checkoutnow' : 'www.paypal.com/checkoutnow');
	}
}
 ...
 */
exports.create = function(username, password, signature, debug, inContext) {
	return new Paypal(username, password, signature, debug, inContext);
};
